...
declare module "chess.js" {
    ...
    export class Chess {
         ...
         * @param options an optional parameter which controls the single-square move generation and verbosity.
         * @returns The list of all valid moves, either in SAN format, or as verbose objects.
         */
        moves(options?: {
         ...
         */
        header(...args: string[]): void | {[key: string]: string};
         ...
         */
        remove(square: string): null | Piece;
