...
export type BodyNextXRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: GameObjectInstance<IBodyState>; // tslint:disable-line:no-banned-terms
    ...
    data: {
        ...
        run: {
            ...
            args: {
                 ...
                 */
                enemy: GameObjectInstance<IUnitState>;
            };
        };
    ...
    data: {
        ...
        run: {
            ...
            args: {
                 ...
                 */
                body: GameObjectInstance<IBodyState>;
            };
        };
    ...
    data: {
        ...
        run: {
            ...
            args: {
                 ...
                 */
                missile: GameObjectInstance<IProjectileState>;
            };
        };
