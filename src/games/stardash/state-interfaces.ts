 ...
 */
export type BodyNextXRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: StateObject<IBodyState>; // tslint:disable-line:no-banned-terms
 ...
 */
export type BodyNextYRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
 ...
 */
export type BodySpawnRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
...
export type UnitAttackRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: StateObject<IUnitState>; // tslint:disable-line:no-banned-terms
 ...
 */
export type UnitDashRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
 ...
 */
export type UnitSafeRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
 ...
 */
export type UnitShootdownRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        run: {
            ...
            args: {
                 ...
                 */
                missile: StateObject<IProjectileState>;
            };
        };
...
export type StardashDelta = StardashSpecificDelta | Exclude<Delta, IRanDelta>;
