 ...
 */
export type CheckerIsMineRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: StateObject<ICheckerState>; // tslint:disable-line:no-banned-terms
 ...
 */
export type CheckerMoveRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        /**
         * Returns the same checker that moved if the move was successful. null
         * otherwise.
         */
        returned: StateObject<ICheckerState>;
    };
};
 ...
 */
export type AIGotCapturedFinishedDelta = IFinishedDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
...
export type CheckersDelta = CheckersSpecificDelta | Exclude<Delta, IRanDelta>;
