...
export type CheckerIsMineRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: GameObjectInstance<ICheckerState>; // tslint:disable-line:no-banned-terms
...
export type CheckerMoveRanDelta = IRanDelta & {
    ...
    data: {
         ...
         * otherwise.
         */
        returned: GameObjectInstance<ICheckerState>;
    };
};
    ...
    data: {
        ...
        order: {
            ...
            args: {
                 ...
                 */
                0: GameObjectInstance<ICheckerState>;
            };
        };
