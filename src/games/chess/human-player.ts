...
export class HumanPlayer extends BaseHumanPlayer {
     ...
     * from the server. - The returned value is A string in Standard Algebriac
     * Notation (SAN) for the move you want to make. If the move is invalid or
     * not properly formatted you will lose the game.
     */
