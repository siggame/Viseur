...
export type BroodMotherConsumeRanDelta = RanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: GameObjectInstance<BroodMotherState>; // tslint:disable-line:no-banned-terms
...
export type CutterCutRanDelta = RanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<CutterState>; // tslint:disable-line:no-banned-terms
...
export type SpiderlingAttackRanDelta = RanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<SpiderlingState>; // tslint:disable-line:no-banned-terms
...
export type SpitterSpitRanDelta = RanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<SpitterState>; // tslint:disable-line:no-banned-terms
...
export type WeaverStrengthenRanDelta = RanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<WeaverState>; // tslint:disable-line:no-banned-terms
