 ...
 * function.
 */
export type BroodMotherConsumeRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: StateObject<IBroodMotherState>; // tslint:disable-line:no-banned-terms
            ...
            args: {
                 ...
                 * this BroodMother.
                 */
                spiderling: StateObject<ISpiderlingState>;
            };
        };
 ...
 * function.
 */
export type BroodMotherSpawnRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
         ...
         */
        returned: StateObject<ISpiderlingState>;
    };
};
 ...
 */
export type CutterCutRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: StateObject<ICutterState>; // tslint:disable-line:no-banned-terms
 ...
 * function.
 */
export type SpiderlingAttackRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: StateObject<ISpiderlingState>; // tslint:disable-line:no-banned-terms
 ...
 */
export type SpiderlingMoveRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
 ...
 */
export type SpitterSpitRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: StateObject<ISpitterState>; // tslint:disable-line:no-banned-terms
 ...
 * function.
 */
export type WeaverStrengthenRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: StateObject<IWeaverState>; // tslint:disable-line:no-banned-terms
 ...
 */
export type WeaverWeakenRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
...
export type SpidersDelta = SpidersSpecificDelta | Exclude<Delta, IRanDelta>;
