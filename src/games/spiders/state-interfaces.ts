...
export type BroodMotherConsumeRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: GameObjectInstance<IBroodMotherState>; // tslint:disable-line:no-banned-terms
            ...
            args: {
                 ...
                 * this BroodMother.
                 */
                spiderling: GameObjectInstance<ISpiderlingState>;
            };
        };
...
export type BroodMotherSpawnRanDelta = IRanDelta & {
    ...
    data: {
         ...
         */
        returned: GameObjectInstance<ISpiderlingState>;
    };
};
...
export type CutterCutRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<ICutterState>; // tslint:disable-line:no-banned-terms
            ...
            args: {
                 ...
                 */
                web: GameObjectInstance<IWebState>;
            };
        };
...
export type SpiderlingAttackRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<ISpiderlingState>; // tslint:disable-line:no-banned-terms
...
export type SpitterSpitRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<ISpitterState>; // tslint:disable-line:no-banned-terms
            ...
            args: {
                 ...
                 */
                nest: GameObjectInstance<INestState>;
            };
        };
...
export type WeaverStrengthenRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<IWeaverState>; // tslint:disable-line:no-banned-terms
