...
export class Spiderling extends Spider {
     ...
     */
    public render(dt: number, current: ISpiderlingState, next: ISpiderlingState,
     ...
     * chance to recolor this Spiderling's sprites.
     */
    public recolor(): void {
        super.recolor();
     ...
     * @param nextReason the reason for the next delta
     */
    public stateUpdated(current: ISpiderlingState, next: ISpiderlingState,
                        reason: IDeltaReason, nextReason: IDeltaReason): void {
