...
export class Spider extends GameObject {
    ...
    /**
     * Constructor for the Spider with basic logic as provided by the Creer
     ...
     */
    public render(dt: number, current: ISpiderState, next: ISpiderState,
     ...
     * chance to recolor this Spider's sprites.
     */
    public recolor(): void {
        super.recolor();
     ...
     * @param nextReason the reason for the next delta
     */
    public stateUpdated(current: ISpiderState, next: ISpiderState,
                        reason: IDeltaReason, nextReason: IDeltaReason): void {
