// This is a class to represent the Nest object in the game.
...
import { INestState } from "./state-interfaces";
 ...
 */
export class Nest extends makeRenderable(GameObject, SHOULD_RENDER) {
     ...
     * so we have a chance to recolor this Nest's sprites.
     */
    public recolor(): void {
        super.recolor();
    ...
    /**
     * Invoked when this Nest instance should not be rendered,
    ...
    public stateUpdated(
        ...
        // update the Nest based off its states
        // <<-- /Creer-Merge: state-updated -->>
    }
