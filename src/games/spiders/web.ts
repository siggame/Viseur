 ...
 */
export class Web extends makeRenderable(GameObject, SHOULD_RENDER) {
     ...
     * so we have a chance to recolor this Web's sprites.
     */
    public recolor(): void {
        super.recolor();
    ...
    /**
     * Invoked when this Web instance should not be rendered,
    ...
    public stateUpdated(
        ...
        // update the Web based off its states
        // <<-- /Creer-Merge: state-updated -->>
    }
