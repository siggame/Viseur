...
export class Job extends GameObject {
    ...
    public current: IJobState;

    /** The next state of the Job (dt = 1) */
    public next: IJobState;
     ...
     * @param game the game this Job is in
     */
    constructor(state: IJobState, game: Game) {
        super(state, game);
    ...
    /**
     * Called approx 60 times a second to update and render Job
     ...
     */
    public render(dt: number, current: IJobState, next: IJobState,
     ...
     * chance to recolor this Job's sprites.
     */
    public recolor(): void {
        super.recolor();
     ...
     * @param nextReason the reason for the next delta
     */
    public stateUpdated(current: IJobState, next: IJobState,
                        reason: IDeltaReason, nextReason: IDeltaReason): void {
