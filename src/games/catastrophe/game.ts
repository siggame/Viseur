...
import { CatastropheDelta, IGameState } from "./state-interfaces";
...
export class Game extends BaseGame {
    ...
    public static readonly gameName = "Catastrophe";
    ...
    public readonly layers = this.createLayers({
        ...
        /** In-between layer, for structure objects */
        structure: this.createLayer(),
