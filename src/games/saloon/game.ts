...
import { IGameState, SaloonDelta } from "./state-interfaces";
...
export class Game extends BaseGame {
    ...
    public readonly layers = this.createLayers({
        ...
        /** The brawler's swing animations */
        brawl: this.createLayer(),

        /** The balcony above the action */
        balcony: this.createLayer(),

        /** The bullets being shot */
        bullets: this.createLayer(),

        /** The music above pianos */
        music: this.createLayer(),
