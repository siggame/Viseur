...
export type CowboyActRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: GameObjectInstance<ICowboyState>; // tslint:disable-line:no-banned-terms
    ...
    data: {
        ...
        run: {
            ...
            args: {
                 ...
                 */
                piano: GameObjectInstance<IFurnishingState>;
            };
        };
...
export type YoungGunCallInRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<IYoungGunState>; // tslint:disable-line:no-banned-terms
         ...
         */
        returned: GameObjectInstance<ICowboyState>;
    };
};
