 ...
 */
export type CowboyActRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: StateObject<ICowboyState>; // tslint:disable-line:no-banned-terms
 ...
 */
export type CowboyMoveRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
 ...
 */
export type CowboyPlayRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        run: {
            ...
            args: {
                 ...
                 */
                piano: StateObject<IFurnishingState>;
            };
        };
 ...
 */
export type YoungGunCallInRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: StateObject<IYoungGunState>; // tslint:disable-line:no-banned-terms
         ...
         */
        returned: StateObject<ICowboyState>;
    };
};
...
export type SaloonDelta = SaloonSpecificDelta | Exclude<Delta, IRanDelta>;
