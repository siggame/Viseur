...
/** All the possible specific deltas in Jungle. */
export type JungleSpecificDelta =
    | GameObjectLogRanDelta
    | AIMakeMoveFinishedDelta;

/** The possible delta objects in Jungle. */
export type JungleDelta = GameSpecificDelta<JungleSpecificDelta>;
