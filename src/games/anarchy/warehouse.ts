...
export class Warehouse extends Building {
     ...
     */
    public render(dt: number, current: IWarehouseState, next: IWarehouseState,
     ...
     * chance to recolor this Warehouse's sprites.
     */
    public recolor(): void {
        super.recolor();
     ...
     * @param nextReason the reason for the next delta
     */
    public stateUpdated(current: IWarehouseState, next: IWarehouseState,
                        reason: IDeltaReason, nextReason: IDeltaReason): void {
