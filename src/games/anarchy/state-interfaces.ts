...
export type FireDepartmentExtinguishRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: GameObjectInstance<IFireDepartmentState>; // tslint:disable-line:no-banned-terms
            ...
            args: {
                 ...
                 */
                building: GameObjectInstance<IBuildingState>;
            };
        };
...
export type PoliceDepartmentRaidRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<IPoliceDepartmentState>; // tslint:disable-line:no-banned-terms
            ...
            args: {
                 ...
                 */
                warehouse: GameObjectInstance<IWarehouseState>;
            };
        };
...
export type WarehouseIgniteRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<IWarehouseState>; // tslint:disable-line:no-banned-terms
...
export type WeatherStationIntensifyRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<IWeatherStationState>; // tslint:disable-line:no-banned-terms
