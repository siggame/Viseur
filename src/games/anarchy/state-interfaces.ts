 ...
 * function.
 */
export type FireDepartmentExtinguishRanDelta = IRanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: StateObject<IFireDepartmentState>; // tslint:disable-line:no-banned-terms
            ...
            args: {
                 ...
                 */
                building: StateObject<IBuildingState>;
            };
        };
 ...
 * function.
 */
export type PoliceDepartmentRaidRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: StateObject<IPoliceDepartmentState>; // tslint:disable-line:no-banned-terms
            ...
            args: {
                 ...
                 */
                warehouse: StateObject<IWarehouseState>;
            };
        };
 ...
 */
export type WarehouseIgniteRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: StateObject<IWarehouseState>; // tslint:disable-line:no-banned-terms
 ...
 * function.
 */
export type WeatherStationIntensifyRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: StateObject<IWeatherStationState>; // tslint:disable-line:no-banned-terms
 ...
 * function.
 */
export type WeatherStationRotateRanDelta = IRanDelta & {
    /** Data about why the run/ran occurred. */
    data: {
        /** The player that requested this game logic be ran. */
        player: StateObject<IPlayerState>;
...
export type AnarchyDelta = AnarchySpecificDelta | Exclude<Delta, IRanDelta>;
