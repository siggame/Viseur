...
export type FireDepartmentExtinguishRanDelta = RanDelta & {
    ...
    data: {
        ...
        run: {
            ...
            caller: GameObjectInstance<FireDepartmentState>; // tslint:disable-line:no-banned-terms
...
export type PoliceDepartmentRaidRanDelta = RanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<PoliceDepartmentState>; // tslint:disable-line:no-banned-terms
...
export type WarehouseIgniteRanDelta = RanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<WarehouseState>; // tslint:disable-line:no-banned-terms
...
export type WeatherStationIntensifyRanDelta = RanDelta & {
    ...
    data: {
        ...
        run: {
            /** The reference to the game object requesting a function to be run. */
            caller: GameObjectInstance<WeatherStationState>; // tslint:disable-line:no-banned-terms
