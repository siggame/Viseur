// This is where you build your the Human player interactions with Viseur for the JungleChess game.
...
/**
 * This is the class to play the JungleChess game as a human.
...
export class HumanPlayer extends BaseHumanPlayer {
     ...
     * value: A string formatting for the move you want to make. If the move is
