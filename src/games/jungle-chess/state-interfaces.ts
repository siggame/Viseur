...
export type AIMakeMoveFinishedDelta = FinishedDelta & {
    ...
    data: {
        ...
        /**
         * A string formatting for the move you want to make. If the move is
...
/** All the possible specific deltas in JungleChess. */
export type JungleChessSpecificDelta =
    | GameObjectLogRanDelta
    | AIMakeMoveFinishedDelta;

/** The possible delta objects in JungleChess. */
export type JungleChessDelta = GameSpecificDelta<JungleChessSpecificDelta>;
