 ...
 */
export class UnitJob extends makeRenderable(GameObject, SHOULD_RENDER) {
    ...
    /**
     * Constructor for the UnitJob with basic logic as provided by the Creer
    ...
    constructor(state: IUnitJobState, viseur: Viseur) {
        ...
        // You can initialize your new UnitJob here.
        // <<-- /Creer-Merge: constructor -->>
    }

    /**
     * Called approx 60 times a second to update and render UnitJob instances.
    ...
    public render(
        ...
        // <<-- Creer-Merge: render -->>
        // render where the UnitJob is
        // <<-- /Creer-Merge: render -->>
    }

    /**
     * Invoked after a player changes their color,
     * so we have a chance to recolor this UnitJob's sprites.
     */
    public recolor(): void {
        super.recolor();
    ...
    /**
     * Invoked when this UnitJob instance should not be rendered,
    ...
    public stateUpdated(
        ...
        // update the UnitJob based off its states
        // <<-- /Creer-Merge: state-updated -->>
    }
