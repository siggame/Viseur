...
<%include file="functions.noCreer" />import { Delta, IBaseGame, IBaseGameObject, IBasePlayer, IFinishedDelta, IRanDelta } from "@cadre/ts-utils/cadre";
...
%           if not is_ai:
            ...
            caller: StateObject<I${game_obj_name}State>; // tslint:disable-line:no-banned-terms
%           endif
...
export type ${game_name}Delta = ${game_name}SpecificDelta | Exclude<Delta, IRanDelta>;
