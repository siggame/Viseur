...
/**
 * @class
 * @classdesc This is the class to play the Stumped game as a human. This is similar to building an "AI", but you need to query the human player for things and then callback actions.
 */
