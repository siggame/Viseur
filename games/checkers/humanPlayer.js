...
/**
 * @class
 * @classdesc This is the class to play the Checkers game as a human. This is similar to building an "AI", but you need to query the human player for things and then callback actions.
 */
var HumanPlayer = Class(BaseHumanPlayer, {
     ...
     *
     * @param {CheckerState} checker - The checker that was captured.
     ...
     */
    gotCaptured: function(checker, callback) {
