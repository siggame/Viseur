 ...
 * @property {number} bribesRemaining - How many bribes this player has remaining to use during their turn. Each action a Building does costs 1 bribe. Any unused bribes are lost at the end of the player's turn.
 * @property {Array.<BuildingState>} buildings - All the buildings owned by this player.
 ...
 * @property {Array.<FireDepartmentState>} fireDepartments - All the FireDepartments owned by this player.
 * @property {string} gameObjectName - String representing the top level Class that this game object is an instance of. Used for reflection to create new instances on clients, but exposed for convenience should AIs want this data.
 * @property {WarehouseState} headquarters - The Warehouse that serves as this player's headquarters and has extra health. If this gets destroyed they lose.
 ...
 * @property {Array.<PoliceDepartmentState>} policeDepartments - All the PoliceDepartments owned by this player.
 ...
 * @property {Array.<WarehouseState>} warehouses - All the warehouses owned by this player. Includes the Headquarters.
 * @property {Array.<WeatherStationState>} weatherStations - All the WeatherStations owned by this player.
